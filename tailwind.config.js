module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Electric Cyan palette — surfaces & ink mapped to CSS vars in globals.css
        'secondary': '#07090c',
        'background': '#0a0d11',
        'background-light': '#141820',
        'top-grad': '#0c1015',
        'bottom-grad': '#07090c',
        'primary-text': '#e8ecf2',
        'secondary-text': '#8a92a0',
        'accent': '#2e3645',
      ...
      backgroundImage: {
        ...
        'background-gradient': 'linear-gradient(180deg, #0c1015 0%, #0a0d11 50%, #07090c 100%)',
        'background-gradient-footer': 'linear-gradient(to right, #141820, #0a0d11)',
        'radial-camera-gradient': 'radial-gradient(circle at 75% 10%, rgba(0, 229, 255, 0.08) 0%, transparent 50%)',
