module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Verde Antico palette — surfaces & ink mapped to CSS vars in globals.css
        'secondary': '#091009',
        'background': '#0c1310',
        'background-light': '#141d18',
        'top-grad': '#0e1612',
        'bottom-grad': '#091009',
        'primary-text': '#ebe7d8',
        'secondary-text': '#8e928a',
        'accent': '#2c3a31',
        // Centralized accent — driven by --accent-color in globals.css
      ...
      backgroundImage: {
        ...
        'background-gradient': 'linear-gradient(180deg, #0e1612 0%, #0c1310 50%, #091009 100%)',
        'background-gradient-footer': 'linear-gradient(to right, #141d18, #0c1310)',
        'radial-camera-gradient': 'radial-gradient(circle at 30% 0%, rgba(235, 231, 216, 0.025) 0%, transparent 50%)',
