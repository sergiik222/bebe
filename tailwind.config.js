module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Apothecary palette — surfaces & ink mapped to CSS vars in globals.css
        'secondary': '#ede7d8',
        'background': '#f4efe5',
        'background-light': '#e8e2d3',
        'top-grad': '#f7f2e9',
        'bottom-grad': '#ede7d8',
        'primary-text': '#1f2a1f',
        'secondary-text': '#5a665a',
        'accent': '#c8c0ad',
      ...
      backgroundImage: {
        ...
        'background-gradient': 'linear-gradient(180deg, #f7f2e9 0%, #f4efe5 50%, #ede7d8 100%)',
        'background-gradient-footer': 'linear-gradient(to right, #e8e2d3, #f4efe5)',
        'radial-camera-gradient': 'radial-gradient(circle at 25% 0%, rgba(138, 106, 58, 0.06) 0%, transparent 55%)',
