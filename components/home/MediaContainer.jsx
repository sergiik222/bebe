...
const MediaContainer = memo(({  middleIndex, isDragging, mediaSize, mediaMargin, windowWidth, medias, isMobileLandscape, onMediaLoaded }) => {
    ...
    return (
        ...
        prevProps.onMediaLoaded === nextProps.onMediaLoaded
    );
});
