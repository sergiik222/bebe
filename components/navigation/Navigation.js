        ...
        <>
            ...
            <nav
                ...
                style={{
                    ...
                    boxShadow: '-4px 0 24px rgba(0, 0, 0, 0.3), inset 0 0 60px rgba(16, 185, 129, 0.03)'
                }}
            >
                {/* Header Section */}
                <div className="px-6 pt-20 pb-6 border-b border-emerald-500/10">
                        ...
                        >
                            <NavLink
                                ...
                                className={`${item.size} font_regular block py-4 px-6 rounded-xl transition-all duration-300 ease-out
                                    ...
                                    hover:bg-emerald-500/8 hover:translate-x-2
                                    hover:shadow-[inset_0_0_20px_rgba(16,185,129,0.05)]
                                    active:bg-emerald-500/12`}
                                activeClassName="!text-emerald-400 !bg-gradient-to-r from-emerald-500/15 to-emerald-500/5 font-semibold shadow-[0_0_20px_rgba(16,185,129,0.15),inset_0_0_30px_rgba(16,185,129,0.08)]"
                            >
                                {item.label}
                            </NavLink>
                        </li>
                ...
                {/* Footer Section */}
                <div className="absolute bottom-0 left-0 right-0 px-6 py-6 border-t border-emerald-500/10">
            ...
            <button
                ...
                style={{
                    background: isOpen ? 'rgba(16, 185, 129, 0.12)' : 'rgba(24, 26, 30, 0.8)',
                    backdropFilter: 'blur(12px)',
                    WebkitBackdropFilter: 'blur(12px)',
                    border: `1px solid ${isOpen ? 'rgba(16, 185, 129, 0.5)' : 'rgba(16, 185, 129, 0.2)'}`,
                    boxShadow: isOpen
                        ? '0 4px 16px rgba(16, 185, 129, 0.3), 0 0 24px rgba(16, 185, 129, 0.2)'
