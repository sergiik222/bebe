    ...
    return (
        ...
        >
            <svg
                ...
                className="w-6 h-6 transition-all duration-300 ease-in-out transform rotate-45 drop-shadow-[0_0_6px_rgba(16,185,129,0.5)] hover:drop-shadow-[0_0_12px_rgba(16,185,129,0.8)]"
            >
                <path
