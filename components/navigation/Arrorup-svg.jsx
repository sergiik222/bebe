    ...
    return (
        ...
        >
            <svg
                ...
                className="w-6 h-6 transition-all duration-300 ease-in-out transform rotate-45 drop-shadow-[0_0_6px_rgba(132,204,22,0.5)] hover:drop-shadow-[0_0_12px_rgba(132,204,22,0.8)]"
            >
                <path
